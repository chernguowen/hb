...
namespace NewsPublish.Service
{
    public class CommentService
    {
        ...
        public ResponseModel GetCommentList(System.Linq.Expressions.Expression<Func<NewsComment, bool>>where)
        {
